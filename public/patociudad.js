// Clase Pato
class Pato {
  constructor(tipo, nombre, apellido, edad, genero, imagen, hijos, pareja, fama) {
...
class PatoFamoso extends Pato {
  constructor(tipo, nombre, apellido, edad, genero, imagen, hijos, pareja, fama) {
    super(tipo, nombre, apellido, edad, genero, imagen, hijos, pareja, fama);
  }
...
class PatoCiudad {
  ...
  cargarFicheroJson(fichero = "patociudad.json") {
    function crearArbolDesdeJson(datos) {
      ...
      const pato =
        tipo == "pato"
          ? new Pato(tipo, nombre, apellido, edad, genero, imagen, hijos, fama)
          : new Pato();
